...
function RestaurantHeader(props) {
  return (
    <div
      ...
      style={{
        background: "linear-gradient(90deg, rgba(202,232,187,1) 0%, rgba(252,129,15,1) 0%, rgba(232,196,149,1) 50%, rgba(132,161,171,1) 100%)",
      }}
    >
      <div className="pl-32">
        <h1 className="text-white text-4xl  pt-8">Taco Bell Cantina</h1>
